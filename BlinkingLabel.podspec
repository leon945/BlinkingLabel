...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Leon de la Garza/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Leon de la Garza' => 'leonjavier945@gmail.com' }
  s.source           = { :git => 'https://github.com/Leon de la Garza/BlinkingLabel.git', :tag => s.version.to_s }
